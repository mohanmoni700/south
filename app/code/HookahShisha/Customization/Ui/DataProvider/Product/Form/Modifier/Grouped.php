...
class Grouped extends \Magento\GroupedProduct\Ui\DataProvider\Product\Form\Modifier\Grouped
{
    ...
    public function __construct(
        ...
        parent::__construct($locator, $urlBuilder, $productLinkRepository, $productRepository, $imageHelper, $status, $attributeSetRepository, $localeCurrency);
    }
    ...
    protected function fillData(ProductInterface $linkedProduct, ProductLinkInterface $linkItem)
    {
        ...
        return [
            ...
            'sqty' => $this->stockState->getStockQty($linkedProduct->getId(), $linkedProduct->getWebsiteIds()),
