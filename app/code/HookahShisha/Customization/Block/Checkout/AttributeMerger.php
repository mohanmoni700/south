 ...
 */
namespace HookahShisha\Customization\Block\Checkout;

use Alfakher\MyDocument\Block\Index\Data as Alfakherdata;
...
class AttributeMerger extends \Magento\Checkout\Block\Checkout\AttributeMerger
{
     ...
     * @param Alfakherdata $alfakherdata
     */
    public function __construct(
        ...
        $this->alfakherdata = $alfakherdata;
    }
    ...
    protected function getFieldConfig(
        ...
        /*check default customer address is from US */
        $shippingAddress = $this->alfakherdata->getCustomeraddress($this->customerSession->getCustomerId());
        ...
        /*requred county for us customer start*/
        if ($attributeCode === 'county') {
            if ($country_id == "US") {
    ...
    protected function getDefaultValue($attributeCode) :  ? string
    {
        ...
        $region_id = $shippingAddress->getData('region_id');
        $country_id = $shippingAddress->getData('country_id');
        $region = $country_id == "US" ? $region_id : '';
        ...
        if ($attributeCode === 'country_id') {
            ...
            if ($defaultCountryId != $country_id) {
