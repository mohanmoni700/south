...
use Magento\ConfigurableProductGraphQl\Model\Resolver\ConfigurableCartItemOptions as ConfigurableCartItemOptionsData;

/**
 * Class to resolve add configurable product to cart functionality in addtocart GraphQL query
 */
class ConfigurableCartItemOptions extends ConfigurableCartItemOptionsData
{
    /**
     * Option type name
     */
