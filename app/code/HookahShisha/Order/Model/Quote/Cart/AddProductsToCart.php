...
namespace HookahShisha\Order\Model\Quote\Cart;
 ...
 */
class AddProductsToCart extends \Magento\Quote\Model\Cart\AddProductsToCart
{
    /**#@+
     * Error message codes
     */
     ...
     * @param \HookahShisha\Order\Model\Quote\Cart\Data\CartItem[] $cartItems
     ...
     * @param \HookahShisha\Order\Model\Quote\Cart\Data\CartItem $cartItem
     * @param int $cartItemPosition
     */
    private function addItemToCart(CartInterface $cart, \HookahShisha\Order\Model\Quote\Cart\Data\CartItem $cartItem, int $cartItemPosition): void
    {
        $sku = $cartItem->getSku();
