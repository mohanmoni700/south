...
class Index extends QuickbooksAccount
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Quickbook Accounts'), __('Quickbook Accounts'));
        $resultPage->getConfig()->getTitle()->prepend(__('Quickbook Accounts'));
        return $resultPage;
    }
}
