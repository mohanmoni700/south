    ...
    function ($, taxRateFactory) {
        ...
        $.widget('mage.mageworxOrderEditorItemsForm', {
            ...
            calculatePriceExclTax: function (input) {
                ...
                /*af_bv_op*/
                var costElem = $("[name='item["+input.item_id+"][cost]']");
                if (costElem.length) {
                    var grossMarginElem = $("[name='item["+input.item_id+"][gross_margin]']");
                    var cost = this.getInputValue(costElem, 0.0);
                    var grossMargin = this.getInputValue(grossMarginElem, 0.0);

                    this.updateGrossMargin(cost, price_excl_tax, input.item_id);
                }
                /*af_bv_op*/
            },
            ...
            calculatePriceInclTax: function (input) {
                ...
                if (costElem.length) {
                    ...
                    this.updateGrossMargin(cost, price, input.item_id);
                }
                /*af_bv_op*/
            },
