...
class AccountPlugin
{
    ...
    {
        $newBlockHtml = $subject->getLayout()->createBlock('\Magento\Framework\View\Element\Template')->setPurchaseOrder($subject->getQuote()->getPurchaseOrder())->setTemplate('Alfakher_GrossMargin::order/create/form/purchaseOrder.phtml')->toHtml();
