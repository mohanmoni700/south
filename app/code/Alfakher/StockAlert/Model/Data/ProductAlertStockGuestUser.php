...
namespace Alfakher\StockAlert\Model\Data;

use Alfakher\StockAlert\Api\Data\ProductAlertStockGuestUserInterface;
use Magento\Framework\Api\AbstractSimpleObject;

class ProductAlertStockGuestUser extends AbstractSimpleObject implements ProductAlertStockGuestUserInterface
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->_get(self::ALERT_STOCK_ID);
    }
    ...
    {
        return $this->_get(self::ADD_DATE);
    }
    ...
    {
        return $this->_get(self::SEND_DATE);
    }
    ...
    {
        return $this->_get(self::SEND_COUNT);
    }
