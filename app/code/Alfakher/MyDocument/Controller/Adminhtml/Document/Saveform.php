...
class Saveform extends \Magento\Backend\App\Action implements HttpPostActionInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Framework\View\Result\PageFactory $resultPageFactory, \Magento\Framework\Controller\Result\RedirectFactory $resultRedirectFactory, MyDocument $documentModel, Data $helper,array $data = []) {
    ...
    public function execute()
    {
        ...
        try
        {
            ...
            $this
                ->messageManager
                ->addSuccess(__('The data has been saved.'));

        } catch (\Exception $e) {
            $this
                ->messageManager
                ->addErrorMessage(__("Something went wrong."));
        }
