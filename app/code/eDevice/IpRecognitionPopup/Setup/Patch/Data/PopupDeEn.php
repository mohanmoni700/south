...
/**
 * Store switching popup on DE (EN language) store for US users
 */
class PopupDeEn implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $storeCode = 'ooka_de_en_store_view';
        $storeId = 0;
        ...
        $cmsBlockData = [
            'title' => 'Store switching popup on DE (EN language) store for US users',
            'identifier' => 'store-switching-popup-ooka_de_en_store_view',
            'content' => '
