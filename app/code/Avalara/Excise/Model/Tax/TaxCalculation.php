...
class TaxCalculation extends \Magento\Tax\Model\TaxCalculation
{
    ...
    {     
        ...
        $exciseResponse = $this->processExciseResponseData($extensionAttributes->getExciseResponse());
                        ...
                        $this->appliedTaxRateDataObjectFactory->create(
                            [  
                                'data' => [
                                    ...
                                    'title' => $transactionTaxes['TaxType']
                                ]
                            ]
                        )
                    ],
