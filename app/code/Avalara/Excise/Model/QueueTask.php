...
class QueueTask
{
    ...
    public function transactionsQueueCommit(
        ...
        $this->logger->debug(__('Initiating transactions processing from cron job'));
        ...
        $this->logger->debug(__('Complete transactions processing from cron job'));
    }
