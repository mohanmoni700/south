    ...
    function (
        ...
        return {
            ...
            buildValidAddress: function (originalAddress, validAddress) {
                ...
                // County
                if (typeof validAddress.extension_attributes !== 'undefined' &&
                    typeof validAddress.extension_attributes.county !== 'undefined') {
                    var origCounty = '';
                    if (typeof originalAddress.extension_attributes !== 'undefined') {
                        origCounty = typeof  originalAddress.extension_attributes.county === 'undefined' ? '' : originalAddress.extension_attributes.county;
                    } else {
                        if (typeof originalAddress.county !== undefined) {
                            origCounty = originalAddress.county
                        }
                    }
                    var validCounty = validAddress.extension_attributes.county;
                    result += this.diffAddressField(origCounty, validCounty) + ", ";
                }
            ...
            buildOriginalAddress: function (originalAddress) {
                ...
                if (typeof originalAddress.extension_attributes !=='undefined') {
                    var origCounty = '';
                    origCounty = typeof  originalAddress.extension_attributes.county === 'undefined' ? '' : originalAddress.extension_attributes.county;
                    result += this.encodeHtml(origCounty) + ", ";
                } else if (typeof originalAddress.county !== "" && typeof originalAddress.county !== 'undefined') {
                    result += this.encodeHtml(originalAddress.county) + ", ";
                }
            ...
            updateFormFields: function (form) {
                ...
                // County
                if (typeof addressModel.selectedAddress().extension_attributes !== 'undefined') {
                    $(form).find("input[name*='county']").attr('value', addressModel.selectedAddress().extension_attributes.county).trigger('change');
                } else {
                    if (typeof addressModel.selectedAddress().county !== undefined) {
                        $(form).find("input[name*='county']").attr('value', addressModel.selectedAddress().county).trigger('change');
                    }
                }
