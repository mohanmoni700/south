...
class Constants
{
     ...
     * Endpoint to get the company list under an account
     */
    const API_V1_EXCISE_COMPANY_LIST_ENDPOINT = '/api/v1/Utilities/GetMasterCompanies';
     ...
     * Connector Id in ATE
     */
    const CONNECTOR_ID = "a0o5a0000064cqHAAQ";

    /**
     * Source System in Tax Transaction API
     */
    const SOURCE_SYSTEM = 'Magento for Tobacco 1.2v2 || '.self::CONNECTOR_ID;
