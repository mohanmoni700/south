...
namespace Avalara\Excise\Helper\Multishipping\Checkout;
...
use Avalara\Excise\Framework\Interaction\Address\Validation;
...
class AddressValidation
{
    ...
    public function validateAddress(
        ...
        if (in_array($address->getCountryId(), explode(',', $this->customerAddressBlock->getCountriesEnabled()))) {
            ...
            try {
                $validAddress = $this->validation->validateAddress(
                    $address,
