...
namespace Avalara\Excise\Test\Integration\Model\Tax\Sales\Total\Quote;
...
class SetupUtil
{
    ...
    const PRODUCT_EXCISE_TAX_CLASS = 'product_excise_tax_class';
    ...
    protected $productTaxClasses = [
        ...
        self::PRODUCT_EXCISE_TAX_CLASS => null,
        self::SHIPPING_TAX_CLASS => null,
    ];

    /**
     * Product tax class metadata such category tax codes
     *
     * @var array
     */
    protected $productTaxClassesMetadata = [
        self::PRODUCT_EXCISE_TAX_CLASS => [
            '' => ''
        ]
    ];
