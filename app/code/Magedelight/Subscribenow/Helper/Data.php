...
class Data extends AbstractHelper
{
    ...
    const XML_PATH_CAN_UPDATE_BILLING_FREQUENCY = 'general/update_billing_frequency';
    const XML_PATH_CAN_UPDATE_NEXT_OCCURRENCE_FROM_FREQUENCY = 'general/update_next_occurrence_on_frequency';
    const XML_PATH_SELECT_AUTO_SHIPPING = 'general/select_auto_shipping';
