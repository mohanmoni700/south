    ...
    return {
        ...
        resolveShippingRates: function (ratesData) {
            var selectedShippingRate = checkoutData.getSelectedShippingRate(),
                availableRate = false, defaultSelected = false;
            ...
            if (!availableRate) {
                if(defaultSelectedShippinEnable){
                    defaultSelected = _.find(ratesData, function (rate) {
                        return rate['carrier_code'] + '_' + rate['method_code'] === defaultSelectedShippinName;
                    });
                    setTimeout(function(){
