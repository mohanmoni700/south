    ...
    rules = {
        ...
        'validate-item-quantity': [
            function (value, element, params) {
                ...
                if (result === false) {
                    validator.itemQtyErrorMessage = $.mage.__('The requested qty is not available. MAX available qty is %1.').replace('%1', params.maxAllowed);//eslint-disable-line max-len
